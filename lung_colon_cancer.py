...
def build_model():
    model = Sequential([
        ...
        Dropout(0.5),
        Dense(len(dataset_paths), activation='softmax')
    ])
    return model
...
# Save model
model.save("lung_colon_cancer_classification_model.h5")

print("Model training complete and saved as 'lung_colon_cancer_classification_model.h5'")
