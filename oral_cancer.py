...
# Train model
print("Training model for Oral Cancer classification...")
model.fit(
    train_generator,
...
# Save model
model.save("oral_cancer_classification_model.h5")

print("Model training complete and saved as 'oral_cancer_classification_model.h5'")
