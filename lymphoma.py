...
# Train model
print("Training model for Lymphoma classification...")
model.fit(
    train_generator,
...
# Save model
model.save("lymphoma_classification_model.h5")

print("Model training complete and saved as 'lymphoma_classification_model.h5'")
